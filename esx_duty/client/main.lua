...
-- Markkerit
AddEventHandler('xkk_duty:hasEnteredMarker', function (zone)
...
AddEventHandler('xkk_duty:hasExitedMarker', function (zone)
  CurrentAction = nil
end)
...
Citizen.CreateThread(function ()
  while true do
    ...
    if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
      ...
      TriggerEvent('xkk_duty:hasEnteredMarker', currentZone)
    end

    if not isInMarker and HasAlreadyEnteredMarker then
      HasAlreadyEnteredMarker = false
      TriggerEvent('xkk_duty:hasExitedMarker', LastZone)
    end
  end
end)
